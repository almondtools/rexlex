...
import com.almondtools.relex.automaton.MatchCollector;
import com.almondtools.relex.automaton.PrefixCollector;
...
public class Automatons {
	...
	public static void store(com.almondtools.relex.automaton.GenericAutomaton.State state) {
		store(new GenericAutomaton(state), 2);
	}

	public static void store(com.almondtools.relex.automaton.DeterministicAutomaton.State state) {
