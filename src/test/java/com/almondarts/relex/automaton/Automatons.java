...
public class Automatons {
	...
	public static void store(com.almondarts.relex.automaton.GenericAutomaton.State state) {
		store(new GenericAutomaton(state), 2);
	}

	public static void store(com.almondarts.relex.automaton.DeterministicAutomaton.State state) {
