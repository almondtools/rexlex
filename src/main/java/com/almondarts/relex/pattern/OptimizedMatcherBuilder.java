...
import com.almondarts.relex.automaton.AutomatonProperty;
...
import com.almondarts.relex.stringsearch.Horspool;
import com.almondarts.relex.stringsearch.SetBackwardOracleMatching;
import com.almondarts.relex.stringsearch.StringMatch;
...
public class OptimizedMatcherBuilder implements MatcherBuilder {
	...
	@Override
	public com.almondarts.relex.pattern.Matcher buildMatcher(String input) {
	...
	private static class StringMatcher extends com.almondarts.relex.pattern.Matcher {

		private com.almondarts.relex.stringsearch.StringFinder finder;
	...
	private static class StringFinder extends com.almondarts.relex.pattern.Finder {
