...
import static com.almondarts.relex.automaton.AutomatonProperty.ACYCLIC;
import static com.almondarts.relex.automaton.AutomatonProperty.CYCLIC;
import static com.almondarts.relex.automaton.AutomatonProperty.LINEAR;
import static com.almondarts.relex.automaton.AutomatonProperty.UNKNOWN;
...
import com.almondarts.collections.HashSets;
import com.almondarts.relex.Token;
import com.almondarts.relex.TokenFactory;
import com.almondarts.relex.TokenType;
import com.almondarts.relex.automaton.FromDeterministicAutomaton.ToGenericAutomaton;
...
import com.almondarts.relex.pattern.TokenIterator;
...
public class DeterministicAutomaton implements Automaton {
	...
	static class State implements Cloneable {
		...
		public com.almondarts.relex.automaton.GenericAutomaton.State toNFA() {
			com.almondarts.relex.automaton.GenericAutomaton.State nfastate = new com.almondarts.relex.automaton.GenericAutomaton.State();
	...
	static abstract class Transition implements Cloneable {
		...
		public abstract com.almondarts.relex.automaton.GenericAutomaton.Transition toNFA(com.almondarts.relex.automaton.GenericAutomaton.State target);
	...
	static class RangeTransition extends Transition {
		...
		@Override
		public com.almondarts.relex.automaton.GenericAutomaton.Transition toNFA(com.almondarts.relex.automaton.GenericAutomaton.State target) {
			return new com.almondarts.relex.automaton.GenericAutomaton.RangeTransition(from, to, target);
		}
	}
	...
	static class ExactTransition extends Transition {
		...
		@Override
		public com.almondarts.relex.automaton.GenericAutomaton.Transition toNFA(com.almondarts.relex.automaton.GenericAutomaton.State target) {
			return new com.almondarts.relex.automaton.GenericAutomaton.ExactTransition(value, target);
		}
	}
