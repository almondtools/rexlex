...
import com.almondtools.relex.automaton.FromDeterministicAutomaton.ToGenericAutomaton;
...
public class DeterministicAutomaton implements Automaton {
	...
	static class State implements Cloneable {
		...
		public com.almondtools.relex.automaton.GenericAutomaton.State toNFA() {
			com.almondtools.relex.automaton.GenericAutomaton.State nfastate = new com.almondtools.relex.automaton.GenericAutomaton.State();
	...
	static abstract class Transition implements Cloneable {
		...
		public abstract com.almondtools.relex.automaton.GenericAutomaton.Transition toNFA(com.almondtools.relex.automaton.GenericAutomaton.State target);
	...
	static class RangeTransition extends Transition {
		...
		@Override
		public com.almondtools.relex.automaton.GenericAutomaton.Transition toNFA(com.almondtools.relex.automaton.GenericAutomaton.State target) {
			return new com.almondtools.relex.automaton.GenericAutomaton.RangeTransition(from, to, target);
		}
	}
	...
	static class ExactTransition extends Transition {
		...
		@Override
		public com.almondtools.relex.automaton.GenericAutomaton.Transition toNFA(com.almondtools.relex.automaton.GenericAutomaton.State target) {
			return new com.almondtools.relex.automaton.GenericAutomaton.ExactTransition(value, target);
		}
	}
