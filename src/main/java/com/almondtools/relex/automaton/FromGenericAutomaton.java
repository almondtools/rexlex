...
import com.almondtools.relex.automaton.DeterministicAutomaton.RangeTransition;
...
public class FromGenericAutomaton {
	...
	public static Map<com.almondtools.relex.automaton.GenericAutomaton.State, State> mapStates(Set<com.almondtools.relex.automaton.GenericAutomaton.State> allStates) {
		IdentityHashMap<com.almondtools.relex.automaton.GenericAutomaton.State, State> mapped = new IdentityHashMap<com.almondtools.relex.automaton.GenericAutomaton.State, State>();
		for (com.almondtools.relex.automaton.GenericAutomaton.State state : allStates) {
			mapped.put(state, new State(state.getType()));
		}
		for (Map.Entry<com.almondtools.relex.automaton.GenericAutomaton.State, State> entry : mapped.entrySet()) {
			com.almondtools.relex.automaton.GenericAutomaton.State key = entry.getKey();
	...
	public static class ToDeterministicAutomaton implements ToAutomaton<GenericAutomaton, DeterministicAutomaton> {
		...
		public DeterministicAutomaton transform(GenericAutomaton automaton) {
			...
			Map<com.almondtools.relex.automaton.GenericAutomaton.State, State> mappedStates = mapStates(almostDeterministic.findAllStates());
	...
	public static class ToMinimalDeterministicAutomaton implements ToAutomaton<GenericAutomaton, DeterministicAutomaton>{
		...
		public DeterministicAutomaton transform(GenericAutomaton automaton) {
			...
			if (remainder != null) {
				...
				Map<com.almondtools.relex.automaton.GenericAutomaton.State, State> mappedStates = mapStates(almostMinimalDeterministic.findAllStates());
